...
const AboutSettings: FC = () => {
  ...
  const mailto = async () => {
    const email = 'juneding7699@gmai.com'
  ...
  const showLicense = async () => {
    ...
    MinApp.start({
      ...
      url: `file://${appPath}/resources/gilt-studio/license.html`,
      logo: AppLogo
    })
  }
  ...
  const showReleases = async () => {
    ...
    MinApp.start({
      ...
      url: `file://${appPath}/resources/gilt-studio/releases.html?theme=${theme === ThemeMode.dark ? 'dark' : 'light'}`,
      logo: AppLogo
    })
  }
    ...
    <SettingContainer theme={theme}>
      <SettingGroup theme={theme}>
        <SettingTitle>
          ...
          <HStack alignItems="center">
            <Link to="https://github.com/juneding76/gilt-studio">
        ...
        <AboutHeader>
          <Row align="middle">
            <AvatarWrapper onClick={() => onOpenWebsite('https://github.com/juneding76/gilt-studio')}>
            ...
            <VersionWrapper>
              ...
              <Tag
                onClick={() => onOpenWebsite('https://github.com/juneding76/gilt-studio/releases')}
                color="cyan"
      ...
      <SettingGroup theme={theme}>
        ...
        <SettingRow>
          ...
          <Button onClick={() => onOpenWebsite('https://giltbridge.com')}>{t('settings.about.website.button')}</Button>
        </SettingRow>
        <SettingDivider />
        <SettingRow>
          <SettingRowTitle>
          ...
          <Button onClick={() => onOpenWebsite('https://github.com/juneding76/gilt-studio/issues/new/choose')}>
      ...
      <SettingGroup theme={theme}>
        ...
        <SettingRow>
          ...
          <Button onClick={() => onOpenWebsite('https://x.com/juneding76')}>
        ...
        <SettingRow>
          ...
          <Button onClick={() => onOpenWebsite('https://t.me/GiltStudioAI')}>
            {t('settings.about.website.button')}
          </Button>
        </SettingRow>
      </SettingGroup>

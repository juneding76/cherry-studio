...
class BackupManager {
  private tempDir = path.join(app.getPath('temp'), 'gilt-studio', 'backup', 'temp')
  private backupDir = path.join(app.getPath('temp'), 'gilt-studio', 'backup')
  ...
  async backupToWebdav(_: Electron.IpcMainInvokeEvent, data: string, webdavConfig: WebDavConfig) {
    const filename = 'gilt-studio.backup.zip'

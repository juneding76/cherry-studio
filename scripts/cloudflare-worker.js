// 配置信息
const config = {
  R2_CUSTOM_DOMAIN: 'giltstudio.ocool.online',
  R2_BUCKET_NAME: 'giltstudio',
  // 缓存键名
  CACHE_KEY: 'gilt-studio-latest-release',
...
async function checkNewRelease(env) {
  try {
    // 获取 GitHub 最新版本
    const githubResponse = await fetch('https://api.github.com/repos/juneding76/gilt-studio/releases/latest', {
